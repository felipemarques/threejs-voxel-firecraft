...
/**
 * Creates a Big Zombie mesh (2x scaled normal zombie)
 * Purple skin with glowing red eyes - double size
 * Based on v1/src/objects/bigZombieElement.js
 */
export function createBigZombie() {
  const group = new THREE.Group()
  group.scale.set(2, 2, 2) // 2x scale
