...
/**
 * Creates a rock with randomized geometry
 * Based on v1/src/objects/rockElement.js
 */
export function createRock() {
  ...
  if (Math.random() > 0.6) {
    const moss = new THREE.Mesh(
      new THREE.CircleGeometry(baseSize * 0.4, 6),
...
/**
 * Creates a tall rock pillar
 */
export function createRockPillar() {
...
/**
 * Creates a flat wide boulder
 */
export function createFlatBoulder() {
...
/**
 * Creates a glowing crystal shard
 */
export function createCrystalShard() {
